...
- [Kong et al. (2025), *Aegis: Automated Error Generation and Attribution for Multi-Agent Systems*](<../raw/Aegis Automated Error Generation and Attribution for Multi-Agent Systems.md>)
...
Tác giả lấy 100 trajectory từ mỗi trong sáu benchmark để lập **Aegis-Bench** test set; dữ liệu còn lại được chia train/validation 80/20. Họ đánh giá khả năng khái quát ngoài phân bố trên [Who&When](<../Failure Attribution - Formulation.md>), đồng thời so sánh model proprietary/open-weight zero-shot với model học từ AEGIS bằng [Aegis-SFT](<../failure attribution methods/Aegis-SFT.md>), [Aegis-GRPO](<../failure attribution methods/Aegis-GRPO.md>) và contrastive learning [DCL](<../failure attribution methods/DCL.md>).
